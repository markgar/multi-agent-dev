...
VALIDATOR_MILESTONE_PROMPT = (
    ...
    "Read SPEC.md for acceptance criteria. Read the milestone files in `milestones/` to see which milestones are "
    "complete — you should test all requirements that should be working up to and "
    "including milestone '{milestone_name}'.\n\n"
    "IMPORTANT: Each milestone file in `milestones/` has a `> **Validates:**` blockquote "
