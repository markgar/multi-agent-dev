...
BACKLOG_QUALITY_PROMPT = (
    ...
    "CRITERION C5 — OVER-SPLITTING:\n"
    "A single CRUD feature (one entity) should not be split into more than 2 stories "
    "(typically backend + frontend). If the same entity appears in 3+ stories where "
    "its CRUD operations are split across them (e.g. 'Books — list', "
    "'Books — create', 'Books — update/delete'), consolidate.\n\n"
