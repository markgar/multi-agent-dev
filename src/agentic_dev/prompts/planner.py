...
BACKLOG_QUALITY_PROMPT = (
    ...
    "story quality in BACKLOG.md and the first milestone in TASKS.md. You must NOT "
    "write any application code or modify any source files other than BACKLOG.md "
    "and TASKS.md.\n\n"
    "STEP 1 — READ:\n"
    "Read BACKLOG.md, TASKS.md, REQUIREMENTS.md, and SPEC.md.\n\n"
    ...
    "For each task in the first milestone: (a) does it include enough detail (file "
    "paths, config keys, field names) for the builder? (b) does it describe one "
    "logical change (not 'and'/'with' connecting distinct work)? (c) does it create "
    "3 or fewer files/endpoints/entities? If 2+ tasks fail, fix them.\n\n"
    ...
    "quality fixes' and TASKS.md with message '[planner] Milestone quality fixes'. "
