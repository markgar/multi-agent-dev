...
REVIEWER_MILESTONE_PROMPT = (
    ...
    "(2) Only include patterns you have seen in 2+ commits or files — one-off issues "
    "stay as findings, not themes. "
    "(3) Drop any themes the builder has already fixed — check the code, not your "
    "memory. "
    "(4) Keep each entry to one line: pattern name in bold + brief actionable "
    "instruction. "
