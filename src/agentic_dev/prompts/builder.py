...
BUILDER_PROMPT = (
    ...
    "Read THEMES.md if it exists — it lists the highest-impact recurring code quality "
    "patterns the reviewer keeps finding across milestones. Avoid repeating these "
    "patterns in new code you write. Do NOT modify THEMES.md — only the reviewer "
    "manages that file. "
    "Only build, "
