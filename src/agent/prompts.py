...
PLANNER_PROMPT = (
    ...
    "features, update existing sections if requirements have changed, but do NOT remove "
    "anything already in SPEC.md that has been built. Commit the updated SPEC.md with "
