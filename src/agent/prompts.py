...
BOOTSTRAP_PROMPT = (
    ...
    "it is the source of truth that all future planning is based on. "
...
PLANNER_PROMPT = (
    ...
    "any source files. Your only job is to manage TASKS.md. Read SPEC.md to understand "
    ...
    "built vs what SPEC.md requires? If TASKS.md does not exist, create it with a "
    "detailed numbered checkbox task list that will achieve everything in SPEC.md. "
